...
int main() {
  ...
  string inputed_string_from_the_user;
  int inputed_roll_from_the_user;
  int inputed_sid_from_the_user ;
  int inputed_age_from_the_user;
  ...
  cout << "Enter the amount of student : ";
   ...
   for(int loop = 0 ; loop <  total_members ; loop ++){
       cout << "Enter the name of student " << loop+1 << " : ";
        getline(cin,inputed_string_from_the_user);
       //~ ------------------------------------------------------------------------->
       cout <<  "Enter Roll number of student "<<loop +1<<": ";
       cin >> inputed_roll_from_the_user;
       //~ ------------------------------------------------------------------------->
       cout << "Enter SID of student "<<loop +1<<": ";
       cin >>  inputed_sid_from_the_user;
       //~ ------------------------------------------------------------------------->
       cout << "Enter the AGE of student :" << loop+1  << ": ";
       cin >>  inputed_age_from_the_user;
       //~ ------------------------------------------------------------------------->
       cout <<  endl <<"<-------------------------------------------->"<< endl;
       cin.ignore(); //~  to clear the newline character from the buffer
       insert(inputed_string_from_the_user,inputed_roll_from_the_user,inputed_sid_from_the_user, inputed_age_from_the_user);
   }
